...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { name: 'sessions', describe: 'cmd.sessions' },
  { name: 'resume', describe: 'cmd.resume' },
...
const INSTANT_WHEN_BUSY: ReadonlySet<string> = new Set(['help', 'goal', 'loop', 'sessions', 'lang', 'mcp', 'plugin']);
 ...
 */
const QUERY_WHEN_NO_ARGS: ReadonlySet<string> = new Set(['model', 'provider', 'permission', 'skill', 'think']);
